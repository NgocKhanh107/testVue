...
const save = () =>{
    ...
    if(voucher.value.ten && voucher.value.ten.trim() ){
        if(voucher.value.id){
             ...
             VoucherService.createVoucher(voucher.value)
            ...
            <div class="card">
                ...
                <Dialog v-model:visible="voucherDialog" :style="{ width: '450px' }" header="Product Details" :modal="true" class="p-fluid">
                    ...
                    <div class="field">
                        ...
                        <!-- <small class="p-invalid" v-if="submitted && !voucher.moTa">Tên không được để trống.</small> -->
                    </div>
                    ...
                    <!-- <div class="field">
                            ...
                            <Dropdown v-model="voucher.trangThai" :options="statuses" optionLabel="label" placeholder="Trạng thái"  />
                    </div> -->
                    <!-- <div class="field">
                        <label for="inventoryStatus" class="mb-3">Trạng Thái</label>
                        <Dropdown id="inventoryStatus" v-model="voucher.trangThai" :options="statuses" optionLabel="label" placeholder="Select a Status">
                            <template #value="slotProps">
                                <div v-if="slotProps.value && slotProps.value.value">
                                    <span :class="'product-badge status-' + slotProps.value.value">{{ slotProps.value.label }}</span>
                                </div>
                                <div v-else-if="slotProps.value && !slotProps.value.value">
                                    <span :class="'product-badge status-' ">{{ slotProps.value }}</span>
                                </div>
                                <span v-else>
